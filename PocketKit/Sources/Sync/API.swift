      ...
      public struct SavedItem: GraphQLSelectionSet {
        ...
        public struct Edge: GraphQLSelectionSet {
          ...
          public struct Node: GraphQLSelectionSet {
            ...
            public init(url: String, itemId: GraphQLID, isArchived: Bool, isFavorite: Bool, _deletedAt: Int? = nil, _createdAt: Int, item: Item) {
              self.init(unsafeResultMap: ["__typename": "SavedItem", "url": url, "itemId": itemId, "isArchived": isArchived, "isFavorite": isFavorite, "_deletedAt": _deletedAt, "_createdAt": _createdAt, "item": item.resultMap])
            }
            ...
            public struct Item: GraphQLSelectionSet {
              ...
              public static func makeItem(givenUrl: String, resolvedUrl: String? = nil, title: String? = nil, language: String? = nil, topImageUrl: String? = nil, timeToRead: Int? = nil, domain: String? = nil, particleJson: String? = nil, excerpt: String? = nil, domainMetadata: AsItem.DomainMetadatum? = nil, images: [AsItem.Image?]? = nil) -> Item {
                return Item(unsafeResultMap: ["__typename": "Item", "givenUrl": givenUrl, "resolvedUrl": resolvedUrl, "title": title, "language": language, "topImageUrl": topImageUrl, "timeToRead": timeToRead, "domain": domain, "particleJson": particleJson, "excerpt": excerpt, "domainMetadata": domainMetadata.flatMap { (value: AsItem.DomainMetadatum) -> ResultMap in value.resultMap }, "images": images.flatMap { (value: [AsItem.Image?]) -> [ResultMap?] in value.map { (value: AsItem.Image?) -> ResultMap? in value.flatMap { (value: AsItem.Image) -> ResultMap in value.resultMap } } }])
              }
              ...
              public struct AsItem: GraphQLSelectionSet {
                ...
                @available(*, deprecated, message: "Use the marticle field instead")
