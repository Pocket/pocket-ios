...
public struct SearchItemParts: PocketGraph.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString { """
    fragment SearchItemParts on Item {
      __typename
      remoteID: itemId
      givenUrl
      resolvedUrl
  ...
  public var topImage: TopImage? { __data["topImage"] }
  ...
  ///
  /// Parent Type: `Image`
  public struct TopImage: PocketGraph.SelectionSet {
    public let __data: DataDict
    public init(data: DataDict) { __data = data }
