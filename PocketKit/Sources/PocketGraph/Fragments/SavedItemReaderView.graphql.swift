...
public struct SavedItemReaderView: PocketGraph.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString { """
    fragment SavedItemReaderView on SavedItem {
      __typename
      url
      remoteID: id
      isArchived
  ...
  public struct Item: PocketGraph.SelectionSet {
    ...
    public struct AsPendingItem: PocketGraph.InlineFragment {
      ...
      public static var __selections: [Selection] { [
        .fragment(PendingItemReaderView.self),
      ] }
