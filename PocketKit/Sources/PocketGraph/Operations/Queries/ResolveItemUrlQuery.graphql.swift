...
public class ResolveItemUrlQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query ResolveItemUrl($url: String!) { itemByUrl(url: $url) { __typename givenUrl normalUrl resolvedUrl savedItem { __typename url id item { __typename ... on Item { shortUrl } } } } }"#
    ))
    ...
    public struct ItemByUrl: PocketGraph.SelectionSet {
      ...
      public struct SavedItem: PocketGraph.SelectionSet {
        ...
        public struct Item: PocketGraph.SelectionSet {
          ...
          /// ItemByUrl.SavedItem.Item.AsItem
          ///
          /// Parent Type: `Item`
          public struct AsItem: PocketGraph.InlineFragment {
            ...
            public typealias RootEntityType = ResolveItemUrlQuery.Data.ItemByUrl.SavedItem.Item
            public static var __parentType: ApolloAPI.ParentType { PocketGraph.Objects.Item }
            public static var __selections: [ApolloAPI.Selection] { [
